  ...
  <span class="hidden-xs"><?php echo $_SESSION['username']; ?></span>
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-header">
                ...
                <p>Welcome To Sistem Informasi Nilai</p>
             </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <h1><center><b>Sistem Informasi Nilai Siswa Sekolah SDN 35 Tegineneng</b></center></h1>
    <!-- Main content -->
    <section class="content">
        ...
        <div class="row">
          <div class="col-lg-2 col-4">
            ...
            <div class="small-box bg-info">
              ...
              <a href="#" class="small-box-footer">Data Pengguna <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-2 col-4">
            ...
            <div class="small-box bg-success">
              ...
              <a href="#" class="small-box-footer">Data Guru <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-2 col-4">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="#" class="small-box-footer">Data Kelas <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-2 col-4">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="#" class="small-box-footer">Data Siswa <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-2 col-4">
            ...
            <div class="small-box bg-danger">
              ...
              <a href="#" class="small-box-footer">Data Mata Pelajaran <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
				<!-- <center><img src=" /></center>
				    <center><h4><b>Pesawaran<strong></center>
            <div class="inner">
