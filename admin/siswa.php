...
<html>
<head>
<title>Data Siswa | Sinilai</title>
<meta charset="utf-8">
							...
							<div class="form-group">
								<label>No Induk Siswa</label>
									<div class="input-group">
										...
										<input name="no induk siswa" type="text" class="form-control" placeholder="No Induk Siswa"/>
									</div>
							</div>
							<div class="form-group">
              ...
              <div class="form-group">
								<label>Tanggal Lahir</label>
									<div class="input-group">
										...
										<input name="tanggal lahir" type="text" class="form-control" placeholder="Tanggal Lahir"/>
									</div>
							</div>
				...
				<div class="form-group">
								<label>Nama Ayah</label>
									<div class="input-group">
										...
										<input name="nama ayah" type="text" class="form-control" placeholder="Nama Ayah"/>
									</div>
							</div>		
				...
				<div class="form-group">
								<label>Nama Ibu</label>
									<div class="input-group">
										...
										<input name="nama ibu" type="text" class="form-control" placeholder="Nama Ibu"/>
									</div>
							</div>
